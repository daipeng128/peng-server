...
public class Const {
    ...
    public static final String SYSTEM_VERSION = "1.4.1";
    public static final String SYSTEM_UPDATE_TIME = "2018-11-30";
    public static final String LAST_SYSTEM_VERSION = "1.4.1";
    public static final String LAST_SYSTEM_UPDATE_TIME = "2018-11-30";
