package com.peng.itrat.core.enums;
...
public enum MessageType {
    ...
    GROUP_TOPIC_REPLY_REPLY("回复了你的群组帖子评论。", '胩'),
    PICTURE_REFER("在图片中提到你了。", '鱁'),
    PICTURE_ZAN("赞了你的图片。", '鱂'),
    PICTURE_REPLY("评论了你的图片。", 'ꀩ'),
    PICTURE_COMMENT_REFER("在图片评论提到你了。", 'ꀪ');

    private String content;
    private int code;

    private MessageType(String content, int code) {
