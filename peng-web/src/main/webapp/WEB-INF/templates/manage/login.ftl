...
<head>
    ...
    <title>PENG后台管理系统登录 - ${SITE_NAME} - Powered By PENG</title>
...
<div class='login'>
    ...
    <div class='disclaimer'>
        <p>欢迎登陆PENG后台管理系统 <a href="../">返回首页</a></p>
        <p>Powered By <a href="http://www.peng.cn" target="_blank">PENG</a> CopyRight © 2012-2017</p>
    </div>
</div>
<div class='authent'>
