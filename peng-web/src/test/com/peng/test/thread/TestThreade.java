...
public class TestThreade {
    ...
    public static void main(String[] args) {
        Account2 account = new Account2("123456", 0);
...
class DrawMoneyThread extends Thread {
    ...
    public DrawMoneyThread(String threadName, Account2 account, double amount) {
        super(threadName);
...
class DepositeMoneyThread extends Thread {
    ...
    public DepositeMoneyThread(String threadName, Account2 account, double amount) {
        super(threadName);
        this.account = account;
        this.amount = amount;
    }
